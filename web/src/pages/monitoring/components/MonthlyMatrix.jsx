        ...
        <thead className="sticky top-0 bg-white dark:bg-gray-900 z-20 border-b border-gray-300 dark:border-gray-700">
          <tr>
            ...
            {months.map((m, i) => (
              <th
                key={i}
                className="p-2 text-center font-semibold border-r border-gray-300 dark:border-gray-700"
              >
                {m.slice(0, 3)}
              </th>
            ))}
            ...
            return (
              ...
              >
                ...
                {u.months.map((m, i) => (
                  <td
                    key={i}
                    className="p-2 border-r border-gray-200 dark:border-gray-600 space-y-1"
                  >
                    <div
                      role="progressbar"
